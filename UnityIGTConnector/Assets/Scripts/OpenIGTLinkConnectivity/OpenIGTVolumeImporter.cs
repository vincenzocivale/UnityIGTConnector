...
namespace UnityVolumeRendering
{
    ...
    public class IGTVolumeImporter
    {
        string filePath;
        private int dimX;
        private int dimY;
        ...
        public IGTVolumeImporter(byte[] iMSGbyteArrayComplete, ReadMessageFromServer.ImageInfo imageInfo)
        {
            this.filePath = null;
        ...
        private void ImportInternal(VolumeDataset dataset, byte[] iMSGbyteArrayComplete, ReadMessageFromServer.ImageInfo imageInfo)
        {
            ...
            int bytesToCopy = uDimension * bytesPerScalar; // Correzione: moltiplica uDimension per bytesPerScalar
            Buffer.BlockCopy(iMSGbyteArrayComplete, imageInfo.OffsetBeforeImageContent, imageData, 0, bytesToCopy); // Usa bytesToCopy
